...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void startGame() {
        newApple();
        running = true; // ensure game starts running
    ...
    public void newApple() {
        ...
        appleY = random.nextInt((int) (SCREEN_HEIGHT / UNIT_SIZE)) * UNIT_SIZE; // FIXED: was appleX before
    }
    ...
    public void move() {
        ...
        switch (direction) {
            ...
            case 'L':
                ...
                break;
            case 'R':
                x[0] = x[0] + UNIT_SIZE; // FIXED: was subtracting before
                break;
        }
    }
